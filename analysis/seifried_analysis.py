...
fh = fits.open(paths.dpath('pv/sourceI_H2Ov2=1_5(5,0)-6(4,3)_robust0.5_diskpv.fits'))
data = fh[0].data
header = fh[0].header
...
voffs = u.Quantity(ww.sub([2]).wcs_pix2world([descend(ii,
                                                      direction=1 if ii < xcen_xpix else -1,
