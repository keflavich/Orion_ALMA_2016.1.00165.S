...
disk_lines = {'Si34S_13-12':229.5008677*u.GHz,
              ...
              'NaClv=0_18-17': 234.25191200*u.GHz, # NaCl v=0 18-17
              'NaClv=1_18-17': 232.50995*u.GHz, # NaCl v=1 18-17
              'NaClv=1_17-16': 219.61493600*u.GHz, # NaCl v=1 17-16
              'NaClv=2_17-16': 217.979967*u.GHz, # NaCl v=2 17-16
              'SiSv=0_12-11': 217.817644*u.GHz,
              'SiSv=1_12-11': 216.7576028*u.GHz, # not in Orion?
              'Si33S_13-12': 232.62854500*u.GHz,
              'SO65-54': 219.94944000*u.GHz, # not in Orion band, but in others
              'H2CO303-202': 218.222192*u.GHz,
              'CH3OH4-3': 218.440063*u.GHz,
              'C18O2-1': 219.5603541*u.GHz,
              'HNCO1010-99': 219.798274*u.GHz,
              # probably best not to label this 'Na37Clv=7_18-17': 217.65559503624314*u.GHz,
              ...
              'K37Clv=0 31-30': 231.21883930648752*u.GHz,
              'KClv=2 31-30': 235.05557839444083*u.GHz,
              'K37Clv=2 31-30': 235.76823524825613*u.GHz,
              'K37Clv=2 30-29': 221.07854314878762*u.GHz,
              ...
              'KClv=2 29-28': 219.93611261476423*u.GHz,
              ...
              '41KClv=1 31-30': 231.08814961918307*u.GHz,
              ...
              # too faint outside Orion '41K37Clv=2_32-31': 230.2206980888192*u.GHz,
              # too faint outside Orion '41K37Clv=1_30-29': 217.17723397093303*u.GHz,
              ...
              'PN5-4': 234.935663*u.GHz, # from Henrik's G351.   Unlikely!!
              'PN5-4v=1': 233.2718*u.GHz,
              ...
              'KClv=2_19-18': 144.2150271643029*u.GHz,
              'KClv=0_20-19': 153.6774964114638*u.GHz,
              'K37Clv=1_J=19-18': 140.99713471788132*u.GHz,
              'KClv=5_J=19-18': 141.5587033680442*u.GHz,
              'KClv=3_J=19-18': 143.32610875213325*u.GHz,
             }
...
other_foreground_lines = {'HNCO_413-312': 88.239027*u.GHz}
...
texnames = {'Si34S_13-12': 'Si$^{34}$S 13-12',
            ...
            'NaClv=0_18-17': 'NaCl v=0 18-17',
            'Na37Clv=6_8-7': 'Na$^{37}$Cl v=6 8-7',
            'Na37Clv=5_8-7': 'Na$^{37}$Cl v=5 8-7',
            'U232.634': 'U232.634', # probably Si 33S J=13-12
            'U229.550': 'U229.550',
            '41KClv=2_31-30': '$^{41}$KCl v=2 31-30', # SLAIM only
            'K37Clv=1_31-30': 'K$^{37}$Cl v=1 31-30',
            'KClv=5 31-30': 'KCl v=5 31-30',
            'KClv=2 13-12': 'KCl v=2 13-12',
            'KClv=1 13-12': 'KCl v=1 13-12',
            'U230.966': 'U230.966',
            'K37Clv=1 29-28': 'K$^{37}$Cl v=1 29-28',
            'KClv=1_29-28': 'KCl v=1 29-28',
            'KClv=3_29-28': 'KCl v=3 29-28',
            'KClv=4_29-28': 'KCl v=4 29-28',
            'H2Ov2=1_5(5,0)-6(4,3)': 'H$_2$O v$_2$=1 $5_{5,0}-6_{4,3}$',
            'NaClv=1_18-17': 'NaCl v=1 18-17', #232.5105*u.GHz,
            'NaClv=1_17-16': 'NaCl v=1 17-16', #217.9795*u.GHz,
            'NaClv=2_17-16': 'NaCl v=2 17-16', #217.9795*u.GHz,
            'SiS_12-11': 'SiS 12-11',
            'Si33S_13-12': 'Si$^{33}$S 13-12',
            'Na37Clv=7_18-17': 'Na$^{37}$Cl v=7 18-17', #217.6660212*u.GHz,
            '41KCl_29-28': '$^{41}$KCl 29-28', #217.5473*u.GHz, # deuterated formic acid?
            'HC3N_24-23': 'HC$_3$N 24-23',
            'HC3N11-10': 'HC$_3$N 11-10',
            'HC3Nv7=1_11-10': 'HC$_3$N v7=1 11-10',
            ...
            '29SiOv=0_5-4': '$^{29}$SiO v=0 5-4', #214.3857577*u.GHz,
            'KClv=6_29-28': 'KCl v=6 29-28', #214.54879*u.GHz,
            'Unknown_12': 'U214.637', #214.637167*u.GHz, # SiSv=3 12-11?
            #'Unknown_13': 215.88712*u.GHz,
            'KClv=5_29-28': 'KCl v=5 29-28', # '$^{13}$CH$_3$OH $4_{2,2}-3_{1,2}$',
            'KClv=2 29-28': 'KCl v=2 29-28',
            'KClv=2 31-30': 'KCl v=2 31-30',
            'K37Clv=2 31-30': 'K$^{37}$Cl v=2 31-30',
            'K37Clv=2 30-29': 'K$^{37}$Cl v=2 30-29',
            'Na37Clv=5_19-18': 'Na$^{37}$Cl v=5 19-18', #233.170797*u.GHz,
            ...
            '29SiOv=0_2-1': '$^{29}$SiO v=0 2-1',
            '29SiOv=2_2-1': '$^{29}$SiO v=2 2-1',
            'SiOv=1_2-1': 'SiO v=1 2-1',
            'SiOv=0_2-1': 'SiO v=0 2-1',
            ...
            'SiOv=0_5-4': 'SiO v=0 5-4',
            'SiOv=1_5-4': 'SiO v=1 5-4',
            ...
            '29SiOv=0_8-7': '$^{29}$SiO v=0 8-7',
            '29SiOv=1_8-7': '$^{29}$SiO v=1 8-7',
            '29SiOv=2_8-7': '$^{29}$SiO v=2 8-7',
            'SiOv=0_8-7': 'SiO v=0 8-7',
            'SiOv=1_8-7': 'SiO v=1 8-7',
            'SiOv=2_8-7': 'SiO v=2 8-7',
            '30SiOv=0_8-7': '$^{30}$SiO v=0 8-7',
            '30SiOv=1_8-7': '$^{30}$SiO v=1 8-7',
            '30SiOv=2_8-7': '$^{30}$SiO v=2 8-7',
            '12CO2-1': '$^{12}$CO 2-1',
            'SO2_2-1_1': 'SO $2_2-1_1$',
            'SO8_8-7_7': 'SO $8_8-7_7$',
            'SO9_8-8_7': 'SO $9_8-8_7$',
            'SO4_5-4_4': 'SO $4_5-4_4$',
            'SO6_5-5_4': 'SO $6_5-5_4$',
            ...
            'SOv=1_3_2-2_1': 'SO v=1 $3_2-2_1$',
            '41KClv=0 31-30': '$^{41}$KCl 31-30',
            'K37Clv=0 31-30': 'K$^{37}$Cl 31-30',
            ...
            'KClv=7_47-46': 'KCl v=7 47-46',
            'KClv=6_47-46': 'KCl v=6 47-46',
            'NaClv=2_27-26': 'NaCl v=2 27-26',
            'NaClv=6_28-27': 'NaCl v=6 28-27',
            'NaClv=6_27-26': 'NaCl v=6 27-26',
            'KClv=8_46-45': 'KCl v=8 46-45',
            'K37Clv=4_46-45': 'K$^{37}$Cl v=4 46-45',
            'K37Clv=6_32-31': 'K$^{37}$Cl v=6 32-31',
            'K37Clv=3_12-11': 'K$^{37}$Cl v=3 12-11',
            '41K37Clv=2_32-31': '$^{41}$K$^{37}$Cl v=2 32-31',
            '41K37Clv=1_30-29': '$^{41}$K$^{37}$Cl v=1 30-29',
            '41KClv=0_13-12': '$^{41}$KCl v=0 13-12',
            'NaClv=8_8-7': 'NaCl v=8 8-7',
            'NaClv=7_8-7': 'NaCl v=7 8-7',
            'K37Clv=6_30-29': 'K$^{37}$Cl v=6 30-29',
            'K37Clv=4_J=32-31': 'K$^{37}$Cl v=4 32-31',
            '41KClv=1 31-30': '$^{41}$KCl v=1 31-30',
            'SiSv=0_12-11': 'SiS v=0 12-11',
            'SiSv=1_12-11': 'SiS v=1 12-11',
            'SiSv=1_13-12': 'SiS v=1 13-12',
            'SiSv=0_13-12': 'SiS v=0 13-12',
            'C18O2-1': 'C$^{18}$O 2-1',
            'HNCO1010-99': 'HNCO $10_{10}-9_9$',
            'SO65-54': 'SO $6_5-5_4$',
            'H2CO303-202': 'H$_2$CO $3_{0,3}-2_{0,2}$',
            'CH3OH4-3': 'CH$_3$OH $4_{2,2}-3_{1,2}$',
            'PN5-4': 'PN J=5-4',
            'PN5-4v=1': 'PN v=1 J=5-4',
            'SOv=0 5(5)-4(4)': 'SO v=0 $5_4-4-4$',
            'NaClv=2_12-11': 'NaCl v=2 12-11',
            'NaClv=2_11-10': 'NaCl v=2 11-10',
            'NaClv=0_11-10': 'NaCl v=0 11-10',
            'NaClv=0_12-11': 'NaCl v=0 12-11',
            'KClv=2_19-18': 'KCl v=2 19-18',
            'KClv=0_20-19': 'KCl v=0 20-19',
            'K37Clv=1_J=19-18': 'K$^{37}$Cl v=1 19-18',
            'KClv=5_J=19-18': 'KCl v=5 19-18',
            'KClv=3_J=19-18': 'KCl v=3 19-18',
}