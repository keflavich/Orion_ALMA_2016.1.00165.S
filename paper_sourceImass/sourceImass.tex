...
\url{https://github.com/keflavich/Orion_ALMA_2016.1.00165.S} with hash \githash
(\gitdate).  The tools used include \texttt{spectral-cube} and
\texttt{radio-beam} from the
\texttt{radio-astro-tools} package
(\url{https://github.com/radio-astro-tools/spectral-cube},
\url{https://github.com/radio-astro-tools/radio-beam}, and
