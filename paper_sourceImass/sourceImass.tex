...
0.5 and -2 weightings.  Continuum-subtracted cubes were produced by subtracting
the median across the 1.8 GHz bandwidth.  All cube analysis was performed using
...
radii, though it is weaker.  No line emission is detected directly toward the disk
center.
...
AU.  There are several plausible explanations for the lack of gas
...
\label{sec:ptsrc}
We have detected a compact (but marginally resolved) source near the
center of the disk at both 3 mm and 1 mm.  The source has a flux rising from 1
