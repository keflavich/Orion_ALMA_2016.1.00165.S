...
\begin{abstract}
   ...
   $5_{5,0}-6_{4,3}$ line, which gives a mass $M_I\approx15\pm2$ \msun.  Using
...
\FigureOneCol{figures/bestfit_powerlaw_H2O_kepler_SeifriedPlot_0.01arcsec.pdf}
...
\acknowledgements{
We thank the anonymous referee for a thorough and helpful review.
...
\FigureOneCol{figures/radius_mass_demo.pdf}
...
% \FigureThree
% {{figures/OrionSourceI_Unknown_5_robust0.5.maskedclarkclean10000_medsub_K_moment0_offset_contours_nocont}.pdf}
% {{figures/OrionSourceI_Unknown_5_robust0.5.maskedclarkclean10000_medsub_K_peak_offset_contours_nocont}.pdf}
% {{figures/sourceI_Unknown_5_B6_robust0.5_diskpv_0.01_withcontour}.pdf}
% {Same as Figure \ref{fig:U5contour}, but with contours overlaid to enable quantitative reading of the plot.
% Panels (a) and (c) have contours at 5, 10, 15, 20, and 25 $\sigma$ and panel
% (b) at 50, 100, 150, and 200 K.
% }
% {fig:U5contour}{1}{2.25in}

%\section{Additional graphics}
%In this final appendix, we show versions of figures in other appendices and in the main text
%with contours overlaid to enable better quantitative reading of the plots.  We avoided putting
%contours in the main document 
%
%\FigureThree
%{figures/keplercurves_sourceI_H2Ov2=1_5(5,0)-6(4,3)_B6_robust-2_diskpv_0.1_withcontour.pdf}
%{figures/keplercurves_sourceI_H2Ov2=1_5(5,0)-6(4,3)_robust-2_diskpv_0.2-0.1_withcontour.pdf}
%{figures/keplercurves_sourceI_H2Ov2=1_5(5,0)-6(4,3)_robust-2_diskpv_0.3-0.2_withcontour.pdf}
%{Duplicate of Figure \ref{fig:waterpvheights} with annotations removed and
%contours (at 5, 10, 15, 20, and 25 $\sigma$) overlaid to enable quantitative
%reading of the plot.
%}
%{fig:waterpvheightscont}{1}{2.2in}
