...
strength.  The peak signal from these lines appears around the $T_B\sim150$ K
contour in the robust -2 weighted 1.3 mm continuum images (Figure
\ref{fig:U1peak}), and the lines are particularly strong at the endpoints of
the disk.  Little line emission is detected where the continuum is brightest,
$T_B\gtrsim300$ K.
